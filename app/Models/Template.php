    ...
    public static function getLabel($type)
    {
        switch ($type) {
            ...
            case self::THANK_YOU_DONATE_PAGE:
                return "Thank you your donation page";
            case self::CONTACT_PAGE:
                return "Contact page";
            case self::EVENTS_PAGE:
                return "Events page";
            case self::VOLUNTEER_PAGE:
                return "Volunteers page";
            case self::CALCULATOR_PAGE:
                return "Zakat calculator page";
            case self::MISSION_POSSIBLE:
                return "Mission possible page";
            case self::VOLUNTEER_START_PAGE:
                return "Volunteers get started page";
        ...
        switch ($template) {
            ...
            case self::EVENT_PAGE: {
                    ...
                    $rules = [
                        ...
                        'parameters.event_description' => 'max:150',
                        ...
                        'parameters.event_end_sale_date' => 'nullable|date',
