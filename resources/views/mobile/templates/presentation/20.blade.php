    ...
    <div class="wrap">
        <div class="title">
            <div class="top">
                ...
                <div class="toggle-title">
                    <div class="text-uppercase"><i class="far fa-chevron-down"></i>{{ $dropdownWhatDoINeedTitle }}
                    </div>
                </div>
            </div>
            <div class="bottom">
        ...
        <nav class="general-content-tabs">
            <ul class="nav nav-tabs nav-fill" id="myTab">
                <li class="nav-item col-6 pl-0 pr-0">
                    <a class="nav-link active letter-spacing-0" id="tab-1-tab" data-toggle="tab" href="#tab-1"
                        role="tab" aria-selected="true">Calculator</a>
                </li>
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="tab-1" role="tabpanel">
                ...
                <div class="calc-below">{!! $calculateBelowTitle !!}</div>
                <div class="black-line mb-4"></div>
                <div class="text-uppercase pl-4 pr-3 letter-spacing-1 font-size-16">
                    <b>{{ $calculateYourAssetsSectionTitle }}</b></div>
                <div class="pt-3"></div>

                <div class="form-group pt-2 pb-2" currency="£">
                    <label><b class="letter-spacing-1">{{ $calculateValueOfGoldTitle }}</b></label>
                    <div currency="£">
                        <input type="number" class="form-control debit-money" placeholder="0.00" currency="£" min="0">
                    </div>
                ...
                <div class="black-line mb-4"></div>
                <div class="text-uppercase pl-4 pr-3 letter-spacing-1 font-size-16">
                    <b>{{ $calculateTradeGoodsSectionTitle }}</b></div>
                <div class="pt-3"></div>
                <div class="form-group pt-2 pb-2" currency="£">
                ...
                <div class="form-group pt-2 pb-2" currency="£">
                    ...
                    <div currency="£">
                        <input type="number" class="form-control credit-money" placeholder="0.00" currency="£" min="0">
                    </div>
                    <div class="pl-3 text-secondary mt-2">
                ...
                <div class="calc">
                    <div class="line"></div>
                    <div class="pt-5"></div>
                    <div class="font-size-25 text-center calc-title"><b>Calculate my Zakat</b></div>
                    <div class="text-center mb-3 position-relative calc-buttons">
                ...
                <div class="down zakat-calculator__down">
                    <div class="bg-danger-light zakat-payable">
                        <div class="total">
                            <div>ZAKAT TOTAL</div>
                            <div class="money-val">
                                <b>£0.00</b>
            ...
            <div class="tab-pane fade tab-text" id="tab-2" role="tabpanel">
                ...
                <div class="information-cards">
                    <div class="information-card">
                        <p class="information-card__title"><b>{{ $whatIsGoldTitle }}</b></p>
                        <p class="information-card__text">{!! $whatIsGoldText !!}
                        </p>
                    </div>

                    <div class="information-card">
                        <p class="information-card__title"><b>{{ $whatIsSilverTitle }}</b></p>
                        <p class="information-card__text">{!! $whatIsSilverText !!}</p>
                        <br>
                    </div>
                </div>
                <div class="last-btn">
