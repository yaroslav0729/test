...
<div class="wrap">
    ...
    <div class="modal-quick-donation">
        <div class="img" style="background-image: url(img/content/m-quick-donation.jpg)">
            <svg class="decor-wave style-white" version="1.0" xmlns="http://www.w3.org/2000/svg" width="2202.000000pt" height="166.000000pt" viewBox="0 0 2202.000000 166.000000" preserveAspectRatio="xMidYMid meet">
    ...
    -16z"/>
        ...
        <div class="form-group">
            <select class="form-control">
                ...
                <option value="0">Monthly donation</option>
            </select>
        </div>
        <div class="form-group">
            <select class="form-control">
...
<section class="whats-new">
    ...
    -16z"/>
            ...
            <b>WHAT'S NEW</b>
<!--            <a href="#" class="text-underline text-uppercase"><b>visit newsroom</b></a>-->
        </div>
        <div>
                    ...
                    <div class="swiper-slide">
                        <div class="item vertical">
                            ...
                            <div class="descr">
                                ...
                                <p class="font-size-16 mb-0">Subtitle capture copy placed here, 40ch...</p>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
