                        ...
                        @foreach ($pages as $page)
                            <div class="swiper-slide">
                                <a href="{{ $page->slug }}" class="item">
                                    ...
                                    <span class="descr">
                                    <span class="name font-size-16">{{ \App\Helpers\StrHelper::lengthLimit($page->name, 20) }} }}</span>
                                    <span class="text font-size-16"><b>{{ \App\Helpers\StrHelper::lengthLimit($page->preview_text, 60) }}</b></span></span>
                                </a>
                            </div>
                        @endforeach
                    @else
                        @foreach ($lastBlogPages as $blog)
                            <div class="swiper-slide">
                                <a href="{{ Request::root()}}/{{ $blog->getActualPageInstanceAttribute()->slug }}" class="item">
                                    ...
                                    <span class="descr">
                                    <span class="name font-size-16">{{ \App\Helpers\StrHelper::lengthLimit($blog->getActualPageInstanceAttribute()->name, 20) }}</span>
                                    <span class="text font-size-16"><b>{{ \App\Helpers\StrHelper::lengthLimit($blog->getActualPageInstanceAttribute()->parameters['hdr_text'], 60) }}</b></span></span>
                                </a>
                            </div>
                        @endforeach
