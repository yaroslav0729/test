...
<section class="discover-more bg-light" swiper-wrapper="related">
    ...
    -16z"/>
        ...
        <div class="text-center mt-5 mb-4">
            <a href="@if ($relPageLink === "") /blog-page @else{{ $relPageLink }} @endif" class="text-uppercase text-underline text-danger font-size-16">
                <b>
                    @if ($relPageLinkTitle === "")
                        VISIT NEWSROOM
                    @else
                ...
                <i class="moon-icons-arrow-right font-size-20"></i></a>
        </div>
    </div>
</section>
