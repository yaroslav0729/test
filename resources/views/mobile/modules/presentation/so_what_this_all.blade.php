...
<section class="so-all-about">
    ...
    <div class="pt-3"></div>
    <div class="pl-4 pr-4">
        <div class="box bg-red text-center pt-5 pb-5">
            <p class="text-white font-size-12 text-uppercase mb-4"><b>Latest mission</b></p>
            <p class="text-white font-size-27 font-weight-light mb-0">
        ...
        <div class="pt-5"></div>
        <div class="pl-4">
            <svg class="decor-wave size-32 style-danger ml-5" version="1.0" xmlns="http://www.w3.org/2000/svg" width="2202.000000pt" height="166.000000pt" viewBox="0 0 2202.000000 166.000000" preserveAspectRatio="xMidYMid meet">
