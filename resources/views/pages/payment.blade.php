                ...
                <form action="{{ route('cart.order') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-5">
                            <div class="form-group">
                                ...
                                <input type="text" id="autocomplete" class="form-control" name="post_code"
                                       autocomplete="off" placeholder="Typo postcode...">
                            </div>
                            <div class="text-right">
                        ...
                        <div class="col-5">
                            ...
                            <div class="text-right">
                                <label class="checkbox rPos">
                                    <input type="checkbox" name="do_sms" value="1"><span><i
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            ...
                            <span class=" cursor-pointer toggle-view-donation-info">CLOSE SUMMARY <i
                        ...
                        <div class="col-6 card-col">
                            <div>
                                ...
                                <div class="mb-4 text-center">
                                    ...
                                    <label class="radio">
                                        <input type="radio" name="pay_method" value="global"><span><i
                                                class="fal fa-check"></i></span>
