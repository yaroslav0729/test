...
@section('content')
    ...
    <div class="donated-page">
        <section class="box">
            <div class="wrap">
                <form id="ramadan-form" action="{{ route('days-of-mercy.store') }}" method="POST">
                    @csrf
                    <input id="frequency" name="frequency" value="1" type="hidden">
                    <p class="font-size-30 mb-5"><b>Your Days of Mercy Donation</b></p>
...
{{--                    </div>--}}
    ...
    <script>
        let startDate = moment('2024-06-07');
        let endDate = moment('2024-06-16');
