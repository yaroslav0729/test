...
@section('scripts')
    ...
    <script type="text/javascript">
        $("#country").on("change",function(){
            ...
            var countryid = $this.find('option:selected').attr("data-id");
            ...
            success: function(data){
                $.each(data, function (i,res) {
                    html+='<option value="'+res.city_name+'" data-id="'+res.city_id+'">'+res.city_name+'</option>';
                });
                $("#city").html(html);
        ...
        $(document).on("change","#city",function(){
            $this= $(this);
            let city_id = $this.find('option:selected').attr('data-id');
            $("#city_id").val(city_id);
        });
// city_id
    </script>
        ...
        <section class="box">
            <div class="wrap">
                <form id="payment-form" action="{{ route('cart.order') }}" method="POST">
                    ...
                    <div class="manual-address" style="@if ($errors->any()) display: block
                        ...
                        <div class="row">
                            ...
                            <div class="col-5">
                                <div class="form-group">
                                    ...
                                    <label class="@error('city') text-danger @enderror"><b>Country</b></label>
                                    <select class="form-control" id="country" name="country">
                                        <option> Select Country</option>
                                    @foreach ( $countries as $country )
                                    <option value="{{ $country['country_name'] }}" data-id="{{ $country['country_id'] }}"> {{ $country['country_name'] }}</option>
                                    @endforeach
                                    </select>
                    ...
                    <div class="row gutter-0">
                        ...
                        <div class="col-6 card-col">
                            <div>
                                ...
                                @if ($hasSingleDonations)
                                    <div class="mb-4 text-center">
                                        <label class="radio mr-5">
                                            <input type="radio" name="pay_method" value="global" checked><span><i
                                                    class="fal fa-check"></i></span>
                                            <b>PAY BY CARD</b>
                                        </label>
                                        <label class="radio">
                                ...
                                <button type="submit" id="cart-pay" class="btn btn-danger border-white btn-submit">Pay
                                    Now</button>
                            </div>
                        </div>
                    </div>
