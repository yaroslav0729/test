            ...
            <div class="col-12">
                <div class="card flex-md-row mb-4 box-shadow h-md-200">
                    <img class="card-img-right flex-auto d-none d-md-block"
                         data-src="holder.js/200x150?theme=thumb" alt="/storage/images/Praying-mosque-background.jpg" style="width: 250px; height: 200px;" src="{{ $page->getActualPageInstanceAttribute()->preview_img ?? '/storage/images/Praying-mosque-background.jpg' }} " data-holder-rendered="true">
