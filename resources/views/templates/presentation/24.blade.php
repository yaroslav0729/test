...
<section class="explore-past-missions style-2 bg-danger-light">
    <div class="row">
        <div class="col-12 @if($widgetHtml) col-md-8 @else col-md-12 feedback-flex @endif pr-5">
            <div class="feedback-title">
                {{ $feedbackTitle }}
            </div>
            <div class="feedback-info-col">
    ...
    -16z" />
                ...
                <div class="feedback-content">
                    ...
                    <a href="{{ $donateNow }}" class="btn btn-danger">Donate Now</a>
                </div>

                <div class="feedback-video-widget">
                    {!! $feedbackVideoWidget !!}
                </div>
            </div>
        </div>
