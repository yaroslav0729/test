...
<section class="explore-past-missions style-2 bg-danger-light">
    <div class="row">
        <div class="col-12 col-md-5 pr-5">
            ...
            <svg class="decor-wave size-80 style-danger mt-n4" style="position: relative; top: 50px; left: -160%"
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="item mt-n4">
                        ...
                        @empty($projText1)
                            <span class="place"><span class="text-dark"><i class="fal fa-map-marker-alt"></i> Tanzania,
                                    africa</span></span>
                        @else
                ...
                <div class="col-12 col-md-6">
                    <div class="item mt-5">
                        ...
                        @empty($projText2)
                            <span class="place"><span class="text-dark"><i class="fal fa-map-marker-alt"></i> LONDON,
                                    UK</span></span>
                        @else
                            <span class="place"><span class="text-dark"><i class="fal fa-map-marker-alt"></i>
                                    {{ $projText2 }}</span></span>
