...
<div class="thank-you-page">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                    <div class="text">
                        ...
                        <p>You're awesome.</p>
                        <svg class="decor-wave style-red size-15" version="1.0" xmlns="http://www.w3.org/2000/svg"
    ...
    -16z" />
                    ...
                    <div class="text-right">
                        <a href="{{ $donationVideoLink }}"
                           class="btn btn-warning text-dark">{{ $donationVideoLinkTitle }}</a>
                    </div>
                </div>
            </div>
        </div>
