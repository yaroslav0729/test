...
<div class="form-group">
    <label>Project subheading:</label>
    <textarea rows="3" class="form-control" name="parameters[proj_subheading]" placeholder="Insert project subheading">{{ $projSubheading }}</textarea>
</div>

<div class="form-group">
    <label>Project image:</label>
    <input class="form-control" name="parameters[proj_image]" placeholder="Insert project image"
        value="{{ $projImage }}" />
</div>

<div class="form-group">
    <label>Project description:</label>
    <textarea rows="3" class="form-control" name="parameters[proj_description]"
        placeholder="Insert text">{{ $projDescription }}</textarea>
</div>
...
<div class="form-group">
    ...
    <textarea rows="3" class="form-control" name="parameters[proj_par1]"
        placeholder="Insert text">{{ $projPar1 }}</textarea>
</div>
...
<div class="form-group">
    ...
    <textarea rows="3" class="form-control" name="parameters[proj_par2]"
        placeholder="Insert text">{{ $projPar2 }}</textarea>
</div>
