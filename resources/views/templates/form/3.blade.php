                ...
                <div class="row mt-3">
                    ...
                    <div class="col-12 mt-2">
                        <div class="form-check">
                            <input class="form-check-input" name="parameters[hdr_type_active_{{ $i }}]" type="checkbox"
                    ...
                    <div class="col-12 mt-2">
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                <label>Header type</label>
                                <select name="parameters[hdr_type_{{ $i }}]" class="form-control">
                                    @for ($j = 1; $j <= 2; $j++)
                                        <option value="{{ $j }}" @if((int)($hdrType[$i]) === $j) selected @endif>Type {{ $j }}</option>
                                    @endfor
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="form-group">
                            ...
                            <textarea wysiwyg-editor="{{ $i }}" id="main_html_{{ $i }}" class="form-control" name="parameters[hdr_title_{{ $i }}]"
