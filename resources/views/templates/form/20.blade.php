@php
    ...
    if (isset($parameters['dropdown_title'])) {
        $whatDoINeedTitle = $parameters['dropdown_title'];
    }

    if (isset($parameters['dropdown_text'])) {
        $whatDoINeedText = $parameters['dropdown_text'];
    }
...
<nav>
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
        <a class="nav-item nav-link active" id="nav-calculate-tab" data-toggle="tab" href="#nav-calculate" role="tab" aria-controls="nav-calculate" aria-selected="true">Calculate my Zakat</a>
        <a class="nav-item nav-link" id="nav-description-tab" data-toggle="tab" href="#nav-description" role="tab" aria-controls="nav-description" aria-selected="false">What is Zakat</a>
        <a class="nav-item nav-link" id="nav-dropdown-tab" data-toggle="tab" href="#nav-dropdown" role="tab" aria-controls="nav-dropdown" aria-selected="false">What do I need (dropdown)</a>
    </div>
</nav>
<div class="tab-content" id="nav-tabContent">
    <div class="tab-pane fade show active" id="nav-calculate" role="tabpanel" aria-labelledby="nav-home-tab">...</div>
        ...
        <div class="row mt-4">
            <div class="col-12 col-lg-6">
                <div class="form-group">
                    ...
                    <input class="form-control" required name="parameters[w_i_zakat_title]"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="parameters[w_i_zakat_text]"
                              placeholder="Text">{!! $whatIsZakatText !!}</textarea>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-6">
                <div class="form-group">
                    ...
                    <input class="form-control" required name="parameters[w_i_obligatory_title]"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="parameters[w_i_obligatory_text]"
                              placeholder="Zakat obligatory text">{!! $whatIsObligatoryText !!}</textarea>
                </div>
            </div>
        ...
        <div class="row mt-4">
            <div class="col-12 col-lg-6">
                <div class="form-group">
                    ...
                    <input class="form-control" required name="parameters[w_i_donate_title]"
            ...
            <div class="col-12 col-lg-6">
                <div class="form-group">
                    ...
                    <input class="form-control" required name="parameters[w_i_receive_title]"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="parameters[w_i_receive_text]"
                              placeholder="Who can receive Zakat text">{!! $whatIsReceiveText !!}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-4">
            <div class="col-12 col-lg-6">
                <div class="form-group">
                    ...
                    <input class="form-control" required name="parameters[w_i_calc_title]"
            ...
            <div class="col-12 col-lg-6">
                <div class="form-group">
                    ...
                    <input class="form-control" required name="parameters[w_i_nisaab_title]"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="parameters[w_i_nisaab_text]"
                              placeholder="How is Nisaab measured text">{!! $whatIsHowNisaabText !!}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-4">
            <div class="col-12 col-lg-6">
                <div class="form-group">
                    ...
                    <input class="form-control" required name="parameters[w_i_should_title]"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="parameters[w_i_should_text]"
                              placeholder="Text">{!! $whatIsShouldUseText !!}</textarea>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-6">
                <div class="form-group">
                    ...
                    <input class="form-control" required name="parameters[w_i_gold_title]"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="parameters[w_i_gold_text]"
                              placeholder="Gold text">{!! $whatIsGoldText !!}</textarea>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-6">
                <div class="form-group">
                    ...
                    <input class="form-control" required name="parameters[w_i_silver_title]"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="parameters[w_i_silver_text]"
                              placeholder="Gold text">{!! $whatIsSilverText !!}</textarea>
                </div>
            </div>
        </div>
    ...
    <div class="tab-pane fade" id="nav-dropdown" role="tabpanel" aria-labelledby="nav-profile-tab">
        <div class="row mt-4">
            <div class="col-12 col-lg-6">
                <div class="form-group">
                    <label>What is Zakat title:</label>
                    <input class="form-control" required name="parameters[dropdown_title]"
                           placeholder="What is Zakat title" value="{{ $whatDoINeedTitle }}"/>
                </div>
