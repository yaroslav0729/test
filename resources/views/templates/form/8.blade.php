        ...
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            @for ($i = 1; $i <= 4; $i++)
                <a class="nav-item nav-link @if ($i===1) active @endif"
                    id="nav-action-tab-{{ $i }}" data-toggle="tab" href="#nav-action-{{ $i }}"
    ...
    <div class="tab-content" id="nav-tabContent">
        @for ($i = 1; $i <= 4; $i++)
            <div class="tab-pane fade show @if ($i===1) active @endif"
                id="nav-action-{{ $i }}" role="tabpanel" aria-labelledby="nav-home-tab">
                <div class="row mt-3">
                    <div class="col-12">
                        <div class="form-check">
                            <input class="form-check-input" name="parameters[action_active_{{ $i }}]"
                                type="checkbox" value="{{ $i }}" id="defaultCheck{{ $i }}" @if (in_array($i, $actionActive)) checked @endif>
                    ...
                    <div class="col-12 col-lg-6 mt-2">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="parameters[action_name_{{ $i }}]"
                                placeholder="Name" value="{!! $actionName[$i] !!}" />
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="parameters[action_photo_{{ $i }}]"
                                placeholder="Insert photo path" value="{!! $actionPhoto[$i] !!}" />
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="form-group">
                            ...
                            <input class="form-control " name="parameters[action_slogan_{{ $i }}]"
                                placeholder="Slogan" value="{!! $actionSlogan[$i] !!}" />
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="form-group">
                            ...
                            <input class="form-control " name="parameters[action_title_{{ $i }}]"
                                placeholder="Title" value="{!! $actionTitle[$i] !!}" />
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="parameters[action_learn_more_link_{{ $i }}]"
                                placeholder="Learn more link" value="{!! $actionLearnMoreLink[$i] !!}" />
                        </div>
                    </div>
                </div>
            </div>
