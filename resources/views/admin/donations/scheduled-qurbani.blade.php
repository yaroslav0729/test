...
@section('content')
    ...
    <div id="admin_content" class="flex-auto px-0">
        <div class="p-5 pb-8">
            <h1 class="admin-page__title">Scheduled Qurbani Donations:</h1>

            <form id="filters" action="{{ route('admin.donations.scheduled-sacrifice') }}" method="get">
                <div class="row">
                ...
                <a href="{{ route('admin.donations.scheduled-sacrifice') }}"><button class="btn btn-info" type="button">Clear all
                        filters</button></a>
            </form>

            <a id="export" href="{{ route('donations.export') }}" data-qurbani="true">
