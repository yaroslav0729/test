                        ...
                        <tbody>
                            ...
                            @foreach ($user->donations as $donation)
                                <tr>
                                    ...
                                    <td class="px-4 py-2">£ {{ $donation->value }}</td>
                                    <td class="px-4 py-2">{{ $donation->type_name }}</td>
                                    <td class="px-4 py-2">{{ $donation->status_name }}</td>
                                    <td class="px-4 py-2">{{ $donation->email }}</td>
