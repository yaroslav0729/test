<div id="left_menu" class="">
    <ul>
        ...
        <li><a href="{{ route('admin.menu_items.index', ['menuSlug' =>'header']) }}"><i class="fas fa-file-alt"></i>Header Menu</a></li>
        <li><a href="{{ route('admin.menu_items.index', ['menuSlug' =>'additional-header']) }}"><i class="fas fa-file-alt"></i>Additional header Menu</a></li>
        <li><a href="{{ route('admin.menu_items.index', ['menuSlug' =>'footer']) }}"><i class="fas fa-file-alt"></i>Footer Menu</a></li>
        <li><a href="{{ route('admin.menu_items.index', ['menuSlug' =>'additional-footer']) }}"><i class="fas fa-file-alt"></i>Additional footer Menu</a></li>
