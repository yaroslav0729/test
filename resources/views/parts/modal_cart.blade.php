            ...
            <div class="modal-body">
                        ...
                        @isset($cartItem[0])
                            <div class="item">
                                ...
                                <div class="row align-items-center mt-4">
                                    ...
                                    <div class="col-4 text-right cart-counter">
                ...
                <div class="down-bar">
                    ...
                    <div class="row align-items-center mt-3">
                        <div class="col-7">
                            <a href="/donate" class="text-underline text-dark"><b class="letter-spacing-1">VIEW MORE PROJECTS</b></a>
                        </div>
                        <div class="col-5 text-right">
                        <a href="{{ url('/donate#about-donation') }}" class="btn_checkout btn btn-danger">Checkout
