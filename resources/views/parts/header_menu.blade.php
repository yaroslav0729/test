    ...
    <div class="wrap">
        ...
        <div style="display: block">
            ...
            <div>
                <ul class="menu">
                    ...
                    <li><a href="#">Our Work + History</a></li>
                    <li><a href="#">Advocacy + Transparency</a></li>
        ...
        <div style="display: none">
            ...
            <div class="categories">
                <div class="name">
                    Change a Child's Life
                    <a href="#"><i class="far fa-long-arrow-left"></i></a>
                </div>
            ...
            <div class="row align-items-center down-menu">
                <div class="col-8">
                    <ul class="d-flex justify-content-between">
                        <li><a href="#">Give Once</a></li>
                        <li><a href="#">Give Monthly</a></li>
                        <li><a href="#">Give Zakat</a></li>
