...
<section class="our-work-term d-none">
    <div class="wrap">
        <div class="mb-4">
            <a href="{{ $ourWorkLink }}" class="text-underline text-dark view-more letter-spacing-1"><b
                    class="text-uppercase">{{ $ourWorkTitle }}</b></a>
        </div>

        <div class="body">
            <div class="bg bg-1 our-work-bg" id="our-work-term-bg-1"><span class="bg-info"></span><span
                    class="bg-info"></span></div>
            <div class="bg bg-2 d-none our-work-bg" id="our-work-term-bg-2"><span class="bg-danger"></span><span
                    class="bg-danger"></span></div>
            <div class="bg bg-3 d-none our-work-bg" id="our-work-term-bg-3"><span class="bg-dark"></span><span
                    class="bg-dark"></span>
            </div>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="box our-work-content" style="background-image: url(img/ico-leaf.svg)"
                        id="our-work-term-1">
                        <h2>{{ $longtermTitle }}</h2>
                        <p>{!! preg_replace('/\s(\S*)$/', '&nbsp;$1', $longtermText) !!}</p>
                    </div>
                    <div class="box d-none our-work-content" style="background-image: url(img/ico-alert.svg)"
                        id="our-work-term-2">
                        <h2>{{ $emergencyTitle }}</h2>
                        <p>{!! $emergencyText !!}</p>
                    </div>
                    <div class="box d-none our-work-content" style="background-image: url(img/ico-motivation.svg)"
                        id="our-work-term-3">
                        <h2>{{ $volunteeringTitle }}</h2>
                        <p>{!! $volunteeringText !!}</p>
                    </div>
                    <div class="box d-none our-work-content" style="background-image: url(img/ico-Saadiqah.svg)"
                        id="our-work-term-4">
                        <h2>{{ $sadiqahTitle }}</h2>
                ...
                <div class="col-6">
                    <div class="img-video videoWrapper our-work-video" id="our-work-video-term-1">
                        <div class="video-poster">
                            <button class="video-poster__play"
                                data-url="https://www.youtube.com/embed/{{ $longtermVideo }}"><i
                                    class="ico-play"></i></button>
                            <img class="video-poster__img" src="@if (!$longtermVideoPreview) https://img.youtube.com/vi/{{ $longtermVideo }}/maxresdefault.jpg @else {{ $longtermVideoPreview }} @endif">
                        </div>
                    ...
                    <div class="img-video d-none videoWrapper our-work-video" id="our-work-video-term-2">
                        <div class="video-poster">
                            <button class="video-poster__play"
                                data-url="https://www.youtube.com/embed/{{ $emergencyVideo }}"><i
                                    class="ico-play"></i></button>
                            <img class="video-poster__img" src="@if (!$emergencyVideoPreview) https://img.youtube.com/vi/{{ $emergencyVideo }}/maxresdefault.jpg @else {{ $emergencyVideoPreview }} @endif">
                        </div>
                    ...
                    <div class="img-video d-none videoWrapper our-work-video" id="our-work-video-term-3">
                        <div class="video-poster">
                            <button class="video-poster__play"
                                data-url="https://www.youtube.com/embed/{{ $volunteeringVideo }}"><i
                                    class="ico-play"></i></button>
                            <img class="video-poster__img" src="@if (!$volunteeringVideo) https://img.youtube.com/vi/{{ $volunteeringVideo }}/maxresdefault.jpg @else {{ $volunteeringVideoPreview }} @endif">
                        </div>
                        <iframe width="1280" height="720"
                            src="https://www.youtube.com/embed/{{ $volunteeringVideo }}" frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                            allowfullscreen></iframe>
                    ...
                    <div class="img-video d-none videoWrapper our-work-video" id="our-work-video-term-4">
                        <div class="video-poster">
                            <button class="video-poster__play"
                                data-url="https://www.youtube.com/embed/{{ $sadiqahVideo }}"><i
                                    class="ico-play"></i></button>
                            <img class="video-poster__img" src="@if (!$sadiqahVideoPreview) https://img.youtube.com/vi/{{ $sadiqahVideo }}/maxresdefault.jpg @else {{ $sadiqahVideoPreview }} @endif">
                        </div>
