            ...
            <div class="col-4">
                ...
                <a href="{{ $topic->slug }}" class="item">
                    ...
                    <span class="descr d-flex flex-column justify-content-between">
                        <span class="name font-size-16 d-block"><b>{{ \App\Helpers\StrHelper::lengthLimit($topic->title, 50) }}</b></span>
                        <span class="text font-size-20 mb-3 mt-5 d-block letter-spacing-0"><b>{{ \App\Helpers\StrHelper::lengthLimit($topic->preview_text, 60) }}</b></span>
