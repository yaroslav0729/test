...
<div class="form-group">
    ...
    <input class="form-control" type="text" name="parameters[who_we_are_block_1_title]" placeholder="Insert value" value="{{ $infoBlock1 }}" />
</div>

<div class="form-group">
    <label>Who we are block1 text:</label>
    <input class="form-control" type="text" name="parameters[who_we_are_block_1_text]" placeholder="Insert value" value="{{ $infoBlockText1 }}" />
</div>

<div class="form-group">
    <label>Who we are block2 title:</label>
    <input class="form-control" type="text" name="parameters[who_we_are_block_2_title]" placeholder="Insert value" value="{{ $infoBlock2 }}" />
</div>

<div class="form-group">
    <label>Who we are block2 text:</label>
    <input class="form-control" type="text" name="parameters[who_we_are_block_2_text]" placeholder="Insert value" value="{{ $infoBlockText2 }}" />
</div>

<div class="form-group">
    <label>Who we are block3 title:</label>
    <input class="form-control" type="text" name="parameters[who_we_are_block_3_title]" placeholder="Insert value" value="{{ $infoBlock3 }}" />
</div>

<div class="form-group">
    <label>Who we are block3 text:</label>
    <input class="form-control" type="text" name="parameters[who_we_are_block_3_text]" placeholder="Insert value" value="{{ $infoBlockText3 }}" />
</div>
