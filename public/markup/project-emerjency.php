<?php include "_header-short.php";?>

<div class="pt-4"></div>
<div class="pt-5"></div>

<section class="donate-today red-gradient">
    <div class="wrap">
        ...
        <div class="body">
            <div class="row gutter-0">
                ...
                <div class="col-6">
                    <div class="donate-today-sheet emergency">
                        <nav>
                            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                <a class="nav-link active color-red"  data-toggle="tab" href="#nav-1" role="tab" aria-selected="true">Single Donation</a>
                                <a class="nav-link color-red"  data-toggle="tab" href="#nav-2" role="tab"  aria-selected="false">Monthly Donation</a>
                            </div>
                        </nav>
...
<section class="donate-today-card emergency">
    <div class="wrap">
        <div class="title">
