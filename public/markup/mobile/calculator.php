...
<section class="calculator">
    <div class="wrap">
        <div class="title">
            ...
            <div class="bottom">
                <div class="line"></div>
                <div class="font-size-14 mb-3"><b>WHAT DO I NEED?</b></div>
                <div>
        ...
        <nav class="general-content-tabs">
            <ul class="nav nav-tabs nav-fill" id="myTab">
                <li class="nav-item">
                    <a class="nav-link active" id="tab-1-tab" data-toggle="tab" href="#tab-1" role="tab" aria-selected="true">Calculator</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="tab-2-tab" data-toggle="tab" href="#tab-2" role="tab"  aria-selected="false">What is Zakat?</a>
                </li>
            </ul>
        </nav>
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="tab-1" role="tabpanel" >
                <div class="row align-items-end gutter-5">
                    ...
                    <div class="col-5"><button class="btn btn-primary h-form-control">£268.83</button></div>
                </div>
                <div class="pt-5"></div>
                ...
                <div class="calc">
                    ...
                    <div class="text-center mb-3 position-relative">
                        ...
                        <button class="btn btn-info ml-1">Calculated</button>
                    </div>
                    <div class="item">
                        <div><b>Total Assets</b><br>
                            For your lunar year</div>
                        <div class="text-right font-size-20"><b>£0.00</b></div>
                    </div>
                    <div class="item">
                    ...
                    <div class="item bg-primary-light">
                        <div>
                            <b>Total Assets</b><br>
                            For your lunar year</div>
                        <div class="text-right font-size-20 text-info"><b>£31'030.00</b></div>
                    </div>
                    <div class="item bg-danger-light">
                        <div><b>Zakat Payable</b><br>
                            For your lunar year</div>
                        <div class="text-right font-size-20 text-danger"><b>£775.75</b></div>
                    </div>
                </div>

                <div class="down">
                    <div class="bg-danger-light pt-4 pb-4 pl-4 pr-4 mb-4">
                        <div class="total">
                            ZAKAT TOTAL
                    ...
                    <div class="pl-4 pr-4">
                        <a href="#" class="btn btn-danger w-100">Danate my Zakat</a>
                    </div>
                </div>
            </div>
