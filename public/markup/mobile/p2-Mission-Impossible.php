        ...
        <div class="col-12">
            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="item">
                            <img src="img/content/Volunteer1.jpg" alt="">
                            <span class="place"><span class="text-dark"><i class="fal fa-map-marker-alt"></i> TEST, TEST</span></span>
                        </div>
                    </div>
                </div>
            ...
            <script>
                var swiper = new Swiper('.explore-past-missions .swiper-container', {
                    pagination: {
                        el: '.explore-past-missions .swiper-pagination'
                    }
                });
            </script>
