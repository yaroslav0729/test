...
<section class="general-content-head bg-light">
    <div class="wrap">
        <div class="img">
            <img src="img/content/general-content-1.jpg" alt="">
        </div>
        <div class="pl-4 pr-4">
            <h1>Article title right here, dem lorem ipsum dolor equisite ut semianor.</h1>
            <div class="date">
                <i></i>26th October 2020
            </div>
        </div>
    </div>
</section>
...
<section class="blog-article-body">
    <div class="body">
        <div class="cite">
            Subcopy perspiciais und etil omnis iste natus error sit demis voluptatem accusantium.
        </div>
        <div class="pt-5"></div>
        <div class="pt-4"></div>
