            ...
            <div class="donate-today-sheet">
                ...
                <nav>
                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                        <a class="nav-link active"  data-toggle="tab" href="#nav-1" role="tab" aria-selected="true">Single</a>
                        <a class="nav-link color-info"  data-toggle="tab" href="#nav-2" role="tab"  aria-selected="false">Monthly</a>
                        <a class="nav-link color-red"  data-toggle="tab" href="#nav-3" role="tab"  aria-selected="false">Appeal</a>
                    </div>
                </nav>
                    ...
                    <div class="tab-pane fade show active" id="nav-1" role="tabpanel" >
                        <form action="/">
                            ...
                            <div class="text-center">
                                <button class="btn btn-danger border-white btn-submit w-100">Donate</button>
                            </div>
                        </form>
                    </div>
...
<section class="donate-projects-list">
    <div class="title text-center">
        <p><b>Donate to a project too?</b></p>
    </div>
    <div class="row">
        ...
        <div class="col-12 col-md-6 col-lg-6 col-xl-4">
            <div class="item selected">
                <div class="img" style="background-image: url(img/content/join-cause-2.jpg)"></div>
                <div class="descr">
                    <div class="name text-ellipsis"><b>Sponsor an orphan</b></div>
                    <div><a href="#" class="font-size-14 text-uppercase text-info"><b>LEARN MORE</b></a></div>
                    <div class="add"><i class="fal fa-check"></i></div>
                </div>
            </div>
        </div>
    </div>
    ...
    -16z"/>
        ...
        <div class="item">
            <div class="row gutter-0">
                <div class="col-12">
                    <div class="mb-3">
                        <p class="font-size-16 mb-0"><b>General Charity</b></p>
                        <p class="font-size-16 mb-0">Single payment</p>
                    </div>
                </div>
                <div class="col-6">
                    <p class="font-size-18 mb-0"><b>£50.00</b></p>
                    <a href="#" class="btn-remove"> <i class="fal fa-times"></i> REMOVE</a>
                </div>
                <div class="col-6 d-flex align-items-center">
                    <input type="number" value="1" min="0" max="1000" step="1" class="color-danger"/>
                </div>
            </div>
        </div>
        <div class="item">
