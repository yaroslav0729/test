...
<section class="who-we-are-head" style="background-image: url(img/bg-contact.jpg);">
    <div>SAY HELLO</div>
    <h1>Get in touch</h1>
</section>
...
<section class="contacts">
    <div class="wrap">
        ...
        <div class="row gutter-30">
            <div class="col-3">
                <h3>Head office</h3>
                <p>Perspiciais und omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem </p>
            </div>
            <div class="col-3">
                <h3>London</h3>
                <p>Perspiciais und omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem </p>
