            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="row gutter-0">
                        <div class="col-8 img" style="background-image: url(img/content/join-cause-2.jpg)"></div>
                        <div class="col-4 text">
                            <div>
                                <div class="tl">Tackling Trials & Tribulations</div>
                                <svg class="decor-wave style-white mb-2" version="1.0" xmlns="http://www.w3.org/2000/svg" width="2202.000000pt" height="166.000000pt" viewBox="0 0 2202.000000 166.000000" preserveAspectRatio="xMidYMid meet">
...
-16z"/>
                                ...
                                <div class="pt-3"></div>
                                <p>We all face challenges in our lives and the Prophets were challenged more than any of us! Learn 7 steps they used to overcome adversity. Max of 150ch.</p>
                                <div class="place"><i class="fal fa-map-marker-alt"></i> birmingham</div>
                                <div>
                                    <div class="date">Oct<span>26</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-slide">
                    <div class="row gutter-0">
                        <div class="col-8 img" style="background-image: url(img/content/ibrahim-rifath-lFcTDevfr5k-unsplash.jpg)"></div>
                        <div class="col-4 text">
                            <div>
                                <div class="tl">Tackling Trials & Tribulations</div>
                                <svg class="decor-wave style-white mb-2" version="1.0" xmlns="http://www.w3.org/2000/svg" width="2202.000000pt" height="166.000000pt" viewBox="0 0 2202.000000 166.000000" preserveAspectRatio="xMidYMid meet">
...
<script>
    var swiper = new Swiper('.events-home-swiper .swiper-container', {
        navigation: {
            nextEl: '.events-home-swiper .swiper-button-next',
            prevEl: '.events-home-swiper .swiper-button-prev',
        },
    });
</script>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="item">
                        ...
                        <span class="row">
                            <span class="col-7">
                                <span class="place"><i class="fal fa-map-marker-alt"></i> birmingham</span>
                            </span>
