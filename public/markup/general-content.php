...
<section class="general-content-head bg-light">
    <div class="wrap">
        <div class="row align-items-center gutter-0">
            <div class="col-6">
                <img src="img/content/general-content-1.jpg" alt="" class="w-100 img-fluid">
            </div>
            <div class="col-6">
                <div class=" pl-5 pr-5">
                    <h1>Article title right here,
                        dem lorem ipsum dolor
                        equisite ut semianor.</h1>
                </div>
            </div>
        </div>
...
<section class="blog-article-body">
    <div class="wrap">
        <div class="body">
            <div class="cite">
                Subcopy right here, perspiciais und omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.
            </div>
            <div class="pt-5"></div>
            <div class="pt-4"></div>
