...
<div class="thank-you-page">
    <div class="wrap">
        <div class="text">
            <div>Thank you, your donation could empower 512 people.</div>
            <p>You're awesome.</p>
    ...
    -16z"/>
        ...
        <div class="box">
            ...
            <div class="pt-3"></div>
            <div class="img-video play-tr" style="background-image: url(img/content/video-thank-you.jpg)"><i class="fas fa-play-circle"></i></div>
            <div class="text-right">
                <a href="#" class="btn  btn-warning">VIEW STORY</a>
            </div>
        </div>
    </div>
</div>
