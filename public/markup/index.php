...
<section class="main-page-header style-4" style="background-image: url('img/content/main-page-header-4.jpg'); display: none1">
    <div class="row">
        <div class="col-6">
            <div class="donate-progress">
                <div class="row mb-3">
    ...
    <div class="row">
        <div class="col-6">
            <div class="body">
                <div class="mb-4">
                    <a href="#" class="text-underline text-white"><b>LEARN MORE</b></a>
                </div>
                <div class="title mb-3">Help the <span class="text-dark">children in Gaza</span> now,</div>
    ...
    <div class="wrap">
        ...
        <div class="body">
            <div class="row gutter-0">
                <div class="col-6">
                    <div class="left">
                        <p class="font-size-30 mb-3"><b>BUILD WATER WELLS, SAVE LIVES</b></p>
                        <p class="font-size-16 mb-5">Critical campaign info, 125 ch. lorem ipsum dolor sit amet, demis vella consectetur desmet velit esse cillum dolore eu nulla.</p>
                        <div>
                            <a href="#" class="btn btn-outline-primary mr-4">Read more</a>
