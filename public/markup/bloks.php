...
<section class="our-work-term">
    <div class="wrpa">
        ...
        <div class="body">
            <div class="bg" id="our-work-term-1-bg"><span class="bg-info"></span><span class="bg-info"></span></div>
            <div class="bg d-none" id="our-work-term-2-bg"><span class="bg-danger"></span><span class="bg-danger"></span></div>
            <div class="bg d-none" id="our-work-term-3-bg"><span class="bg-dark"></span><span class="bg-dark"></span></div>
            <div class="bg d-none" id="our-work-term-4-bg"><span class="bg-warning"></span><span class="bg-warning"></span></div>
            <div class="row">
                <div class="col-6">
                    <div class="box" style="background-image: url(img/ico-leaf.svg)" id="our-work-term-1">
                        <h2>Longterm Projects</h2>
                        <p>You can help us build our projects to empower those in need, 340 ch. lorem ipsum dolor sit ametion, consectetur rehederit in volud ut perspiciatis unde omni iste natus error sitan voluptat accusantium doloremque laudantium, tota rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabio.</p>
                    </div>
                    <div class="box d-none" style="background-image: url(img/ico-alert.svg)" id="our-work-term-2">
                        <h2>Emergency Relief</h2>
                        <p>Or give to immediate emergencies we are supporting now, 340 ch. lorem ipsum dolor sit amet, consectetur rehederit in volud ut perspiciatis unde omnis iste natusian error sit voluptatem accusantium doloremque laudantium, totami rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabio.  </p>
                    </div>
                    <div class="box d-none" style="background-image: url(img/ico-motivation.svg)" id="our-work-term-3">
                        <h2>Volunteering</h2>
                        <p>Giving your time is one of the best ways of giving, 340 ch. lorem ipsum dolor sit amet, consectetur rehederit in volud utan perspiciatis unde omnis iste natus error sitians voluptatem accusantium doloremque laudantium, totami remi aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto betaens vitae dicta sunt explicabio.</p>
                    </div>
                    <div class="box d-none" style="background-image: url(img/ico-Saadiqah.svg)" id="our-work-term-4">
                        <h2>Sadiqah</h2>
                        <p>Giving your time is one of the best ways of giving, 340 ch. lorem ipsum dolor sit amet, consectetur rehederit in volud utan perspiciatis unde omnis iste natus error sitians voluptatem accusantium doloremque laudantium, totami remi aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto betaens vitae dicta sunt explicabio.</p>
                    </div>
                ...
                <div class="col-6">
                    <div class="img-video" style="background-image: url(img/content/Video-placement-1.jpg)" id="our-work-term-1-video">
                        <i class="fas fa-play-circle"></i>
                        <div class="caption bg-info">IH sponsorships <b>orphans</b></div>
                    </div>
                    <div class="img-video d-none" style="background-image: url(img/content/Video-placement-1.jpg)" id="our-work-term-2-video">
                        <i class="fas fa-play-circle"></i>
                        <div class="caption bg-danger">IH sponsorships <b>orphans</b></div>
                    </div>
                    <div class="img-video d-none" style="background-image: url(img/content/Video-placement-1.jpg)" id="our-work-term-3-video">
                        <i class="fas fa-play-circle"></i>
                        <div class="caption bg-primary">IH sponsorships <b>orphans</b></div>
                    </div>
                    <div class="img-video d-none" style="background-image: url(img/content/Video-placement-1.jpg)" id="our-work-term-4-video">
                        <i class="fas fa-play-circle"></i>
                    ...
                    <div class="row nav gutter-10 actions">
                        <div class="col-4 d-none">
                            <a href="#" data-target="1"><span style="background-image: url(img/ico-leaf.svg)"></span></a>
                        </div>
                        <div class="col-4">
                            <a href="#" data-target="2"><span style="background-image: url(img/ico-alert.svg)"></span></a>
                        </div>
                        <div class="col-4">
                            <a href="#" data-target="3"><span style="background-image: url(img/ico-motivation.svg)"></span></a>
                        </div>
                        <div class="col-4">
                            <a href="#" data-target="4"><span style="background-image: url(img/ico-Saadiqah.svg)"></span></a>
                        </div>
                    </div>
...
<section class="widget-about-project">
    ...
    <div class="row gutter-0">
        ...
        <div class="col-6 descr d-flex align-items-center">
            <div>
                <p class="font-size-30 text-uppercase" style="font-weight: 100"><b>Automate donations</b> with my ten nights</p>
...
<section class="join-cause pt-0 pb-0">
    <div class="wrap">
    ...
    -16z"/>
            ...
            <div class="col-12 col-xl-6">
                ...
                <form action="/" class="d-flex">
                    ...
                    <button type="submit" >Subscribe <i class="far fa-chevron-right"></i></button>
                </form>
            </div>
        </div>
    </div>
