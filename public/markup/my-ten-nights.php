...
<section class="who-we-are-head" style="background-image: url(img/content/my-ten-nights-top.jpg);">
    <div>MY TEN NIGHTS</div>
    <h1>Reap the rewards<br>of Laylut Qadr</h1>
</section>
...
<section class="blog-article-body">
    <div class="wrap">
        <div class="body">
            <h2 class="font-size-20">There are no days more blessed than those in the month of Ramadan and there is no night more powerful than Laylat ul Qadr, also known as the Night of Power or Night of Decree.   The importance of this night is clearly mentioned in the Quran:</h2>
