...
(function () {
  ...
  var extended = function extended(element, rowspan, colspan, row, column) {
    return {
      element: element,
      rowspan: rowspan,
      colspan: colspan,
  ...
  var elementnew = function elementnew(element, isNew) {
    return {
      element: element,
      isNew: isNew
    };
  ...
  var statsStruct = function statsStruct(minRow, minCol, maxRow, maxCol) {
    return {
      minRow: minRow,
      minCol: minCol,
      maxRow: maxRow,
  ...
  var adjustWidthTo = function adjustWidthTo(table, list, tableSize) {
  ...
  var resizeTable = function resizeTable() {
    ...
    var calcLeftEdgeDeltas = function calcLeftEdgeDeltas(sizes, index, next, delta, minCellSize, relativeSizing) {
      if (relativeSizing) {
    ...
    var calcMiddleDeltas = function calcMiddleDeltas(sizes, _prev, index, next, delta, minCellSize, relativeSizing) {
    ...
    var calcRightEdgeDeltas = function calcRightEdgeDeltas(sizes, _prev, index, delta, minCellSize, relativeSizing) {
      if (relativeSizing) {
        return calcRelativeDeltas(sizes, index, delta, minCellSize);
      } else {
        var clampedDelta = clampNegativeDelta(sizes, index, delta, minCellSize);
  ...
  var preserveTable = function preserveTable() {
    ...
    var calcRightEdgeDeltas = function calcRightEdgeDeltas(sizes, _prev, _index, delta, _minCellSize, relativeSizing) {
      if (relativeSizing) {
        return zero(sizes);
      } else {
  ...
  var generateElements = function generateElements(cells, row, generators) {
  ...
  var rowFill = function rowFill(grid, amount, generators) {
  ...
  var colFill = function colFill(grid, amount, generators) {
    return map(grid, function (row) {
  ...
  var verifyGenerators = exactly(['cell', 'row', 'replace', 'gap', 'col', 'colgroup']);
  ...
  var opInsertColumnsBefore = function opInsertColumnsBefore(grid, details, comparator, genWrappers) {
  ...
  var opInsertColumnsAfter = function opInsertColumnsAfter(grid, details, comparator, genWrappers) {
  ...
  var opMergeCells = function opMergeCells(grid, mergable, comparator, _genWrappers) {
  ...
  var switchCellType = function switchCellType(dom, cells, newCellType, scope) {
  ...
  var applyCellData = function applyCellData(editor, cells, data) {
    var dom = editor.dom;
  ...
  var getSelectionTargets = function getSelectionTargets(editor, selections) {
    var _targets = Cell(Optional.none());
    ...
    var findTargets = function findTargets() {
      return getSelectionStartCellOrCaption(getSelectionStart(editor)).bind(function (cellOrCaption) {
        ...
        var isCaption = function isCaption(elem) {
...
/***/ 2:
/*!************************************************************!*\
  !*** multi ./node_modules/tinymce/plugins/table/plugin.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/vetal33/PhpstormProjects/islamichelp/node_modules/tinymce/plugins/table/plugin.js */"./node_modules/tinymce/plugins/table/plugin.js");
